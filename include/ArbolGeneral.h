...
/**
  ...
  *
  * nod raiz!=NULL (==NULL si Arbol General esta vacio)
  *
  * @section faConjunto Función de abstracción
  *
  * Una objeto Arbol General valido representa una jerarquía de objetos en la que cada objeto puede tener algun o ningún hijo.
  */
  ...
  public:
    ...
    /**
      ...
      * queda sin dichos nodos. Si el hermano derecha no existe, el árbol inicial
	  * no varía y dest recibe el valor nulo.
      * La operación se realiza en tiempo O(1).
      */
    ...
    class iter_preorden{
	 ...
	 /**
	  * @brief Obtiene el puntero al nodo actual
	  * 
	  * */
	 Nodo Elem();
     ...
     */
     ...
     iter_preorden begin() const;
     const_iter_preorden el_begin()const;	
     
     
    /**
     * @brief Inicializa un iterador al nodo nulo con la raiz del arbol. Nivel 0
     */
     iter_preorden end() const;
     const_iter_preorden el_end()const; 
